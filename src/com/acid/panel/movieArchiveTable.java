...
public class movieArchiveTable extends JPanel {
    ...
    public movieArchiveTable() {
        ...
        imgPanel = new JPanel();
        imgPanel.setBounds(0,500,800,240);

        icon = new ImageIcon("img/banner.jpg");
        ...
        hintLable.setBounds(290,460,160,50);
        ...
        countLable.setBounds(290,460,160,50);
    ...
    public void setInterectable(boolean a){
        table.getTableHeader().setReorderingAllowed(a);
        table.setRowSorter(null);
        table.setRowSelectionAllowed(a);
        table.setColumnSelectionAllowed(a);
        table.setCellSelectionEnabled(a);
        table.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                e.consume(); // 消耗事件，不进行处理
            }
        });
